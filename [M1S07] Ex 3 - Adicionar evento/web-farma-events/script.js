...
for (var i = 0; i < addProductButtons.length; i++) {
	addProductButtons[i].addEventListener("click", function(){
		const nomeProdutoClicado = event.target.previousElementSibling.previousElementSibling.previousElementSibling;
		carrinhoCompras.push(nomeProdutoClicado.textContent);
		alert(nomeProdutoClicado.textContent + ' foi adicionado ao seu carrinho')
